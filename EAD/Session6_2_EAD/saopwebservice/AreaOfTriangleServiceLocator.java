...
public class AreaOfTriangleServiceLocator extends org.apache.axis.client.Service implements saopwebservice.AreaOfTriangleService {
    ...
    private java.lang.String AreaOfTriangle_address = "http://localhost:8080/saopwebservice/services/AreaOfTriangle";
    ...
    public saopwebservice.AreaOfTriangle getAreaOfTriangle() throws javax.xml.rpc.ServiceException {
    ...
    public saopwebservice.AreaOfTriangle getAreaOfTriangle(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            saopwebservice.AreaOfTriangleSoapBindingStub _stub = new saopwebservice.AreaOfTriangleSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (saopwebservice.AreaOfTriangle.class.isAssignableFrom(serviceEndpointInterface)) {
                saopwebservice.AreaOfTriangleSoapBindingStub _stub = new saopwebservice.AreaOfTriangleSoapBindingStub(new java.net.URL(AreaOfTriangle_address), this);
                _stub.setPortName(getAreaOfTriangleWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://saopwebservice", "AreaOfTriangleService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://saopwebservice", "AreaOfTriangle"));
        }
